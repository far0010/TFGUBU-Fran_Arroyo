...
test('Crear Solicitante a convocatoria sin titulación', async t => {
    ...
    await t
        ...
        .click(Selector('span.t-Button-label').withText('Cancel').parent('button'))
   ...
   // Esperamos a que aparezca la nueva fila (posición siguiente)
    ...
    await t
        ...
        .eql('-', 'No debe haber valor en el campo REF_CON');
});
