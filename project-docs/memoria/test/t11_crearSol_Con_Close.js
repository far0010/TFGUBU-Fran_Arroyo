...
import {BUTTON, USERNAME, PASSW, FILASANTES, FILASDESPUES, CONFILASTABLA, TOGICON2,
    SOLICITANTEMENU, SOLICITHEAD, SELECTITSOL, SOLICDIPLO, SELECONVSOL,SOLICONVO} from './constanst.js';

fixture`Test Suite`.page("https://192.168.2.61:8443/apex/f?p=100:LOGIN_DESKTOP:12651011480748:::::");

test('Crear Solicitante a convocatoria cerrada', async t => {
    ...
    await t
        ...
        .typeText(Selector('input[name="P7_DNI_SOL"]'), '00001FAKE')
        .typeText(Selector('input[name="P7_APE1_SOL"]'), 'Pérez')
        .typeText(Selector('input[name="P7_APE2_SOL"]'), 'López')
        .typeText(Selector('input[name="P7_NOM_SOL"]'), 'Juan')
        .click(SELECTITSOL)
        .click(SOLICDIPLO)
        .click(SELECONVSOL)
        .click(SOLICONVO)
